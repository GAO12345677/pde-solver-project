...
# 测试 2：测试豆包连接（使用正确的 API Key）
print("\n2. 测试豆包连接（使用正确的 API Key）")
try:
    payload = {
        "model_name": "doubao",
...
# 测试 3：测试豆包连接（使用空 API Key）
print("\n3. 测试豆包连接（使用空 API Key）")
try:
    payload = {
        "model_name": "doubao",
        "api_key": "",
...
# 测试 4：测试豆包连接（缺少 model_id）
print("\n4. 测试豆包连接（缺少 model_id）")
try:
    payload = {
        "model_name": "doubao",
        "api_key": "0dd4ec9c-9b5f-42d1-a705-a7e9bdea37ce",
...
# 测试 5：测试豆包连接（使用错误的 API Key）
print("\n5. 测试豆包连接（使用错误的 API Key）")
try:
    payload = {
        "model_name": "doubao",
        "api_key": "wrong_key",
